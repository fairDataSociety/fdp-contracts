...
export const ENS_ENVIRONMENT_CONFIGS: EnsEnvironmentConfigs = {
  ...
  [Environments.OPTIMISM_GOERLI]: {
    ...
    contractAddresses: {
      ...
      reverseResolver: process.env.OPTIMISM_REVERSE_RESOLVER_ADDRESS as EthAddress,
      nameResolver: process.env.OPTIMISM_NAME_RESOLVER_ADDRESS as EthAddress,
    },
  ...
  [Environments.ARBITRUM_GOERLI]: {
    ...
    contractAddresses: {
      ...
      reverseResolver: process.env.ARBITRUM_REVERSE_RESOLVER_ADDRESS as EthAddress,
      nameResolver: process.env.ARBITRUM_NAME_RESOLVER_ADDRESS as EthAddress,
    },
